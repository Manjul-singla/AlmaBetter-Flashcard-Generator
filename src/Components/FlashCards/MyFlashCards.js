    ...
    <>
      ...
      <div className="flex flex-wrap space-evenly sm:px-8 md:px-8 lg:px-8 xl:px-8 px-2 ">
        ...
        {flashCard.slice(0, ShowCards).map((elem) => {
          return (
            <div
              className=" m-2 flex dark:text-gray-300 hover:scale-105 transform duration-300 overflow-hidden justify-center pt-12 drop-shadow-md"
              key={elem.id}
            >
              <img
              ...
              <div className="bg-white border dark:bg-gray-700 px-4 w-[250px] xl:w-[300px] sm:w-[300px] lg:w-[300px] md:w-[300px] h-64  pt-11 pb-2 rounded-lg dark:border-gray-500 ">
                ...
                <div className="flex flex-col items-center ">
                  ...
                  <span className="font-bold my-2">
                    {" "}
                    {Object.keys(elem.term).length} Cards
                  </span>
      ...
      {flashCard.length > 6 ? (
        <div className="flex justify-end mr-10">
          ...
          {ShowCards === flashCard.length ? (
            <button
              onClick={ShowLess}
              className="mb-24 font-bold  cursor-pointer w-24 mx-5 text-red-500"
            >
              {" "}
              See less
            </button>
